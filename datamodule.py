...
class ExampleDataModule(LightningDataModule):
    def __init__(
        ...
        self.train_image3d_files = glob_files(folders=train_image3d_folders, extension="**/*.tif")
        self.train_image2d_files = glob_files(folders=train_image2d_folders, extension="**/*.png")

        self.val_image3d_files = glob_files(folders=val_image3d_folders, extension="**/*.tif")  # TODO
        self.val_image2d_files = glob_files(folders=val_image2d_folders, extension="**/*.png")

        self.test_image3d_files = glob_files(folders=test_image3d_folders, extension="**/*.tif")  # TODO
        self.test_image2d_files = glob_files(folders=test_image2d_folders, extension="**/*.png")
